...
<head>
    ...
    <style>
        <?php
            include(dirname(__DIR__, 3).DIRECTORY_SEPARATOR.'public\assets\css\bootstrap.min.css');
            include(dirname(__DIR__, 3).DIRECTORY_SEPARATOR.'public\assets\css\style.css');
         ?>
    </style>
